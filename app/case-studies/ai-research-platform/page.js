  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-12">
        ...
        <a href="/prds/ai-research-platform" className="inline-block text-sm font-mono text-gray-900 hover:text-gray-600 transition border-b border-gray-900 hover:border-gray-600">
          Read the full PRD →
        </a>
      </section>
