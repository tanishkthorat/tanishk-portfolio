  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-12">
        ...
        <a href="/prds/trading-platform" className="inline-flex items-center gap-2 px-5 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-700 transition font-mono text-sm">
