          ...
          <a href="/case-studies/ai-research-platform" className="block p-8 border border-gray-200 rounded-lg hover:border-gray-900 hover:bg-gray-50 transition">
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed">A self-hosted research tool I built to learn where private RAG systems actually break. Dual-GPU inference, a multi-stage pipeline, and a strict no-fabrication discipline. One user: me, daily.</p>
              </div>
          ...
          <a href="/case-studies/trading-platform" className="block p-8 border border-gray-200 rounded-lg hover:border-gray-900 hover:bg-gray-50 transition">
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed">A swing trading research system built on top of the AI Research Platform. Natural-language strategy compilation, deterministic execution, regime-aware risk controls. One user: me. No live trading.</p>
              </div>
              <span className="text-gray-400 text-2xl mt-1">→</span>
            </div>
          </a>
